...
def make_to_string(front, mid, back, empty_repr):
    ...
    def convert(lnk):
        if lnk is Link.empty:
            ...
            return front + str(lnk.first) + mid + convert(lnk.rest) + back
    return convert
...
def tree_map(fn, t):
    ...
    if t.is_leaf():
        ...
        mapping_branches = [tree_map(fn, branch) for branch in t.branches]
        return Tree(fn(t.label), mapping_branches)
